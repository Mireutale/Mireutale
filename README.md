<!-- 
capsule-render, 배너 설정

type: soft 
  -> 렌더링 스타일
color: 0:99e1ab,100:f8fcf7
  -> 그래디언트 색상 (0%: #e8e8e8 -> 100%: #c0c0c0)
height: 120
  -> 배너의 높이 (픽셀 단위)
text: Taejin Kang's GitHub
  -> 표시될 텍스트 내용
animation: fadeIn
  -> 애니메이션 효과
fontColor: 333333
...
<picture>
  <source media="(prefers-color-scheme: dark)"
    srcset="https://capsule-render.vercel.app/api?type=waving&color=c0c0c0&fontColor=e8e8e8&height=120&section=header&text=Taejin%20Kang%27s%20GitHub&fontSize=40"/>
  <img src="https://capsule-render.vercel.app/api?type=waving&color=c0c0c0&fontColor=333333&height=120&section=header&text=Taejin%20Kang%27s%20GitHub&fontSize=40"/>
</picture>
...
|   날짜   |                     대회명                      |      참여       |   팀    |               주관 / 수여                |
| :------: | :---------------------------------------------: | :-------------: | :-----: | :--------------------------------------: |
| 25.07.15 |               2025 K-ICT in Busan               | 부산대학교 대표 | Pilltip |    **SK 그룹**<br>SK Telecom 주식회사    |
...
<div align="left">
  ...
  <img src="https://img.shields.io/badge/Spring-7df18b?style=for-the-badge&logo=Spring&logoColor=green">
  <img src="https://img.shields.io/badge/Spring Boot-7df18b?style=for-the-badge&logo=SpringBoot&logoColor=white">
...
## Problem Solving
<div align="center">
  <img src="http://mazassumnida.wtf/api/v2/generate_badge?boj=priaselay">
</div>